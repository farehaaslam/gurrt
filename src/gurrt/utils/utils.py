...
def captioning_ollama(video_path: Path,
    ...
    with tqdm(total = len(frame_PIL), desc="\033[1;32mProcessing frames...\033[0m") as pbar: 
...
def temporal_persistence_filter(video_path: Path,
    ...
    frame_index = 0
    with tqdm(total=n_sampled,
            desc="\033[1;32mTemporal Persistence Filtering Frames...\033[0m") as pbar:
        while True:
